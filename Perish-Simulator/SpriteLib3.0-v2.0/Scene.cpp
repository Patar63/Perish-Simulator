...
void Scene::boundary(int spriteSizeX, int spriteSizeY, float positionX, float positionY, int angle, float transparency)
{
	//Creates entity 
	auto entity = ECS::CreateEntity();
	...
	tempPhsBody = PhysicsBody(entity, tempBody, float(tempSpr.GetWidth() - shrinkX),
		float(tempSpr.GetHeight() - shrinkY), vec2(0.f, 0.f), false, GROUND, OBJECTS | ENVIRONMENT | ENEMY);
